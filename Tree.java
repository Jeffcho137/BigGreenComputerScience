 ...
 *
 * 
 * new class that holds key value pair
 * a majority of the code is from BST.java except pairs were changed to Character, Integer
 * and getValue and getKey methods were added
 *
 */
...
public class Tree {
	...
	/**
	 * Returns the value associated with the search key, or throws an exception if not in Tree
	 */
	...
	public Tree delete(Character search) throws InvalidKeyException {
		...
		if (compare == 0) {
			...
			// If both children are there, delete and suTreeitute the successor (smallest on right)
			// Find it
